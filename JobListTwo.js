...
export default class test extends Component {
    constructor(props){
        super(props)
         this.state = {styleIndex0:0,styleIndex1:0,styleIndex2:0,styleIndex3:0,styleIndex4:0,styleIndex5:0,
        isVisible:false,
    ...
    onButtonPress(id){ 
      ...
      switch(id){
        ...
        default: this.setState({styleIndex5: 1}); break;
 ...
 render() {
    ...
    <View style={styles.container} >
        ...
        <TouchableOpacity onPress={ () => {this.onButtonPress(5);this.toggle()}} style={this.state.styleIndex5 === 0 ? styles.buttonStyle : styles.buttonStyleClicked}>
